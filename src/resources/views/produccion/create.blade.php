...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('produccion.proyectos.index') }}" class="text-gray-500 hover:text-gray-700">← Volver</a>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 max-w-2xl">
        <form action="{{ route('produccion.proyectos.store') }}" method="POST" class="p-6 space-y-5">
            @csrf
